...
public class PermissionUpdateParam {
   ...
   public PermissionUpdateParam(Long id, String name, String description, Integer status) {
      this.id = id;
      this.name = name;
   ...
   public static class Builder {
      ...
      public Builder withStatus(Integer value) {
         ...
         withCalled.put("status", status != null);
         return this;
      }

      public PermissionUpdateParam build() {
         ...
         return new PermissionUpdateParam(id, name, description, status);
      }
   }
}
