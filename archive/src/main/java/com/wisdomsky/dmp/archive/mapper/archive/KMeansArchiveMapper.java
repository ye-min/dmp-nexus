...
@Mapper
public interface KMeansArchiveMapper {
   @Select(" select count(*) from wis_archive_kmeans ")
   long count();

   @Select(" select count(*) from wis_archive_kmeans a " +
   ...
   KMeansArchive findDetail(@Param("id") int id);
  ...
  List<StudentKMeansArchive> findStudentPageList(
   ...
   List<KMeansArchive> findPersonalList(
         @Param("count") int count,
         @Param("offset") int offset,
         @Param("accountId") int accountId,
         @Param("startTime") String startTime,
   ...
   @Insert(" insert into wis_archive_kmeans (record_time, account_id, result_dataset, " +
   ...
   int insert(@Param("record") KMeansArchive record);

   @Delete(" delete from wis_archive_kmeans where id = #{id}")
